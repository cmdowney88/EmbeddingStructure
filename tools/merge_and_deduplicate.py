...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Merge text files, removing duplicate and blank lines")
    parser.add_argument(
        '--input_files',
        nargs='*',
        type=str,
    ...
    for input_file in args.input_files:
        file_lines = [line.strip() for line in open(input_file, 'r') if line.strip() != '']
